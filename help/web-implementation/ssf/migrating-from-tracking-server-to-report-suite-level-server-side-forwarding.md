...
Adobe Audience Manager 및 Adobe Analytics이 있는 경우 [!DNL Analytics] 데이터의 서버측 전달을 Audience Manager에 구현할 수 있습니다. 즉, 페이지에서 두 개의 히트(하나는 [!DNL Analytics]에, 하나는 Audience Manager에)를 보내는 대신 [!DNL Analytics]에 히트를 보낼 수 있으며 [!DNL Analytics]에서 해당 데이터를 Audience Manager에 전달합니다.
