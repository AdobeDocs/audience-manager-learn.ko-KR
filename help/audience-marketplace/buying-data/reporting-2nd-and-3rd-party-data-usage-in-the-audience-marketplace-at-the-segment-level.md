...
이 비디오는 [!UICONTROL Payables] UI의 [!UICONTROL Audience Marketplace] 섹션 내에서 데이터 사용을 보고하는 새로운 방법을 보여 줍니다. 이제 피드 수준 보고의 기존 프로세스 외에도 세그먼트 수준에서 월간 노출수를 제출할 수 있으므로 비용 속성에 대한 오프라인 계산이 필요하지 않습니다.
