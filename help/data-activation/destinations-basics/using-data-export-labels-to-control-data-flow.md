...
description: Audience Manager의 데이터 내보내기 레이블에 대해 알아봅니다. 개인 정보 보호 요구 사항을 충족할 수 있도록 다양한 데이터 유형/소스의 흐름을 제어할 수 있는 메커니즘을 Audience Manager에 제공합니다. 데이터 내보내기 제어 및 데이터 내보내기 레이블을 이를 위해 동시에 작동하도록 설정하는 방법과 위치를 알아봅니다.
