...
source-git-commit: 948124cc2eff5d2f622aea353027909ee1e562d1
workflow-type: tm+mt
...
+ Audience Manager 소개 {#intro-to-audience-manager}
  ...
  + [Audience Manager 활용 사례](intro-to-audience-manager/audience-manager-use-cases.md)
...
+ 업계 뉴스 및 트렌드 {#industry}
  ...
  + [Audience Center of Excellence 진화](https://experienceleague.adobe.com/docs/platform-learn/tutorials/industry/evolving-your-audience-center-of-excellence.html?lang=ko)
  + [고객 프로필을 통해 더 나은 경험 구축](https://experienceleague.adobe.com/docs/platform-learn/tutorials/industry/building-better-experiences-with-customer-profiles.html?lang=ko)
...
+ 웹 구현 {#web-implementation}
  ...
  + SSF(서버측 전달) {#ssf}
    + [Experience Platform 태그를 사용하여 웹 사이트에 구현](https://experienceleague.adobe.com/docs/launch-learn/implementing-in-websites-with-launch/index.html?lang=ko)
...
+ 모바일 구현 {#mobile-implementation}
  ...
  + [iOS Objective-C 애플리케이션에서 구현](https://experienceleague.adobe.com/docs/launch-learn/implementing-in-mobile-ios-objective-c-apps-with-launch/index.html?lang=ko)
  + [Android 애플리케이션에서 구현](https://experienceleague.adobe.com/docs/launch-learn/implementing-in-mobile-android-apps-with-launch/index.html?lang=ko)
...
+ 대상자 구축 및 관리 {#build-and-manage-audiences}
  + 데이터 탐색기 {#data-explorer}
    ...
    + [Data Explorer을 사용하여 사용 및 사용하지 않는 키/값 쌍 검색](build-and-manage-audiences/data-explorer/using-data-explorer-to-search-for-used-and-unused-key-value-pairs.md)
    ...
    + [Data Explorer을 사용하여 소급 트레이트 및 세그먼트 만들기](build-and-manage-audiences/data-explorer/using-data-explorer-to-create-retroactive-traits-and-segments.md)
    ...
    + [Data Explorer을 사용하여 Adobe Analytics에서 오는 신호로 작업합니다](build-and-manage-audiences/data-explorer/using-data-explorer-to-work-with-signals-coming-from-adobe-analytics.md)
...
+ 데이터 활성화 {#data-activation}
  ...
  + Audience Lab {#audience-lab}
    ...
    + [전환 트레이트 만들기](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-conversion-traits.html?lang=ko)
...
+ 기타 통합 {#other-integrations}
  + Real-time Customer Data Platform과 통합 {#integrating-with-rtcdp}
    + [Adobe Audience Manager Data Connector를 사용하여 데이터 수집](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-aam.html?lang=ko#sources)
